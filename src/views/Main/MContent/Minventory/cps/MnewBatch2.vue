  ...
  <div class="inventory">
    ...
    >
      ...
      <a-row>
        ...
        <a-col :span="12">
          <a-form-item label="过期时间" name="date-picker" v-bind="rules">
            <a-input-group>
              <a-row :gutter="8">
                <a-col :span="12">
                  <a-date-picker
    ...
    <table class="table table-standard">
      ...
      <tr>
        ...
        <td>
          ...
          >
            <a-input placeholder="单行输入" style="width: 80%;"></a-input>
          </a-form-item>
        </td>
        <td>
        ...
        <td>
          <a-input placeholder="" style="width: 80px;"></a-input>
          <label class="space-10">ml</label>
        </td>
        <td>
    ...
    <div class="modal">
      ...
      >
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="存放位置" name="username">
              <a-input-group>
                <a-row :gutter="8">
                  <a-col :span="12">
                    <a-select style="width:100%">
        ...
        <a-row>
          <a-col :span="12">
            <a-form-item label="报损原因" name="username">
              <a-input-group>
                <a-row :gutter="8">
                  <a-col :span="16">
                    <a-input v-model:value="formState.username" />
      ...
      <p style="text-align: center">
        <img style="width: 80%" :src="sample.url" alt="" />
      </p>
      <table class="table table-bordered-bg">
        <tr>
      ...
      <section style="margin-top: 40px;">
        ...
        <p>
          该品类 <span class="ft16">“甲醇中吡菌磷”</span
          ><strong class="red ft16">低于安全库存</strong>，请尽快补充
        </p>
        <table class="table table-bordered-bg">
          <tr>
